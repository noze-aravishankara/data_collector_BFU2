...
class CO2Sensor(ABCDevice):
    ...
    def get_instance():
        ...
        """
        if CO2Sensor.__instance == None:
            CO2Sensor()
        return CO2Sensor.__instance

    def __init__(self):
        """Virtually private constructor.
        """
        if CO2Sensor.__instance is not None:
            return None
        else:
            CO2Sensor.__instance = self
    ...
    def initialize(self, connection_port, baudrate=9600, timeout=10, target_temperature=30):
        ...
        try:
            ...
            get_logger().info("Successfully connected to CO2 sensor at port {}.".format(connection_port))
            return True
    ...
    def terminate(self):
        ...
        time.sleep(1)
        get_logger().info("Closing the CO2 sensor connected to {}".format(self._connection.port))
