...
class HumiditySensor(ABCDevice):
    """
    """
    name = "humidity"
    __instance = None
    ...
    def get_instance():
        ...
        """
        if HumiditySensor.__instance == None:
            HumiditySensor()
        return HumiditySensor.__instance

    def __init__(self):
        """Virtually private constructor.
        """
        if HumiditySensor.__instance is not None:
            return None
        else:
            HumiditySensor.__instance = self
    ...
    def initialize(self, connection_port, baudrate=9600, timeout=10, target_temperature=30):
        ...
        try:
            ...
            get_logger().info("Successfully connected to humidity sensor at port {}.".format(connection_port))
            return True
    ...
    def terminate(self):
        ...
        time.sleep(1)
        get_logger().info("Closing the humidity sensor connected to {}".format(self._connection.port))
