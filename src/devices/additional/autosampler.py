...
class Autosampler(ABCDevice):
    ...
    def _set_protocol(self, instruction, status):
        ...
        pick_up_location = (825, -342)
        min_height_with_holder = (775, -80)
        min_height_without_holder = (775, -80)
        ...
        if instruction == "Baseline":
            ...
            self.setSampler_Status(status,location)
        ...
        if instruction == "Exposure_11" or instruction == "Exposure_21" or instruction == "Exposure_31" :
            start_time = datetime.now()
        ...
        if instruction == "Exposure_12" or instruction == "Exposure_22" or instruction == "Exposure_32":
            start_time = datetime.now()
        ...
        if instruction == "Exposure_13" or instruction == "Exposure_23" or instruction == "Exposure_33":
            start_time = datetime.now()
            self.setSampler_Status(status,location)
        ...
        if instruction == "Exposure_14" or instruction == "Exposure_24" or instruction == "Exposure_34":
            start_time = datetime.now()
            self.setSampler_Status(status,location)
        ...
        if instruction == "Recovery_11" or instruction == "Recovery_21" or instruction == "Recovery_31":
            start_time = datetime.now()
            position_x, position_z = position_11
            min_height_with_holder_x, min_height_with_holder_z = min_height_with_holder
            pick_up_location_x, pick_up_location_z = pick_up_location
        ...
        if instruction == "Recovery_12" or instruction == "Recovery_22" or instruction == "Recovery_32":
            start_time = datetime.now()
            position_x, position_z = position_12
            min_height_with_holder_x, min_height_with_holder_z = min_height_with_holder
            pick_up_location_x, pick_up_location_z = pick_up_location
        ...
        if instruction == "Recovery_13" or instruction == "Recovery_23" or instruction == "Recovery_33":
            start_time = datetime.now()
            position_x, position_z = position_13
            min_height_with_holder_x, min_height_with_holder_z = min_height_with_holder
            pick_up_location_x, pick_up_location_z = pick_up_location
        ...
        if instruction == "Recovery_14" or instruction == "Recovery_24" or instruction == "Recovery_34":
            start_time = datetime.now()
            position_x, position_z = position_14
            min_height_with_holder_x, min_height_with_holder_z = min_height_with_holder
            pick_up_location_x, pick_up_location_z = pick_up_location
    ...
    def _start_collection(self):
        ...
        while (self._status == Status.RUNNING):
            try:
                x = str(Autosampler.SAMPLER_STATE) + "," + str(Autosampler.LOCATION)
    ...
    def setSampler_Status(self, status,location):
        # Autosampler.state_buffer_lock.acquire()

        # if Autosampler.state_buffer_lock.locked():
        Autosampler.SAMPLER_STATE = status
        Autosampler.LOCATION = location
