...
"""Module containing abstract base class for any data transmitter device.
...
class ABCDevice:
    ...
    def terminate(self):
        ...
        """
        raise NotImplementedError("The method terminate must be implemented to terminate the connection to device properly.")